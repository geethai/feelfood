...
import com.smartmobion.feelhungry.adapters.NavigationDrawerListAdapter;
import com.smartmobion.feelhungry.models.Items;
...
public class BaseActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_items.add(new Items("Item One", R.drawable.item_1));
		_items.add(new Items("Item Two", R.drawable.item_2));
		_items.add(new Items("Item Three", R.drawable.item_3));
		_items.add(new Items("Item Four", R.drawable.item_4));
		_items.add(new Items("Item Five", R.drawable.item_5));
