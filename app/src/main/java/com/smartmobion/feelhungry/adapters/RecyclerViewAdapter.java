...
import com.smartmobion.feelhungry.AccountFragment;
import com.smartmobion.feelhungry.RestuarantFragment;
import com.smartmobion.feelhungry.R;
import com.smartmobion.feelhungry.AddressFragment;
import com.smartmobion.feelhungry.DealsFragment;
import com.smartmobion.feelhungry.MainActivity;
import com.smartmobion.feelhungry.RestuarantListActivity;
import com.smartmobion.feelhungry.Restuarants;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
   ...
   public RecyclerViewAdapter(String[] titles, TypedArray icons, Context context){
    ...
    // The default constructor to receive titles,icons and context from MainActivity.
    public RecyclerViewAdapter(TypedArray icons, Context context){
        ...
        public void onClick(View v) {
            ...
            switch (getPosition()){
                case 1:
                    ...
                    fragmentTransaction.replace(R.id.containerView,addressFragment);
                    fragmentTransaction.commit();
                    break;
                case 2:
                    /*Fragment fixtureFragment = new RestuarantFragment();
                    fragmentTransaction.replace(R.id.containerView, fixtureFragment);
                    fragmentTransaction.commit();*/

                    context.startActivity(new Intent(context,Restuarants.class));
                    break;
                case 3:
                    Fragment tableFragment = new DealsFragment();
                    fragmentTransaction.replace(R.id.containerView,tableFragment);
                    fragmentTransaction.commit();
                    break;
                case 5:
                    Fragment myaccountFragment = new AccountFragment();
                    fragmentTransaction.replace(R.id.containerView, myaccountFragment);
                    fragmentTransaction.commit();
                    break;
            }
        }
