...
import com.smartmobion.feelhungry.adapters.RecyclerViewAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        *A LayoutManager must be provided for RecyclerView to function.
        ...
        //Add the Very First i.e Address Fragment to the Container
        Fragment addressFragment = new AddressFragment();
        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.id.containerView,addressFragment,null);
